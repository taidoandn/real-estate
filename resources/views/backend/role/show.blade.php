        ...
        <div class="col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <p class="panel-title">
                        DataTables Roles
                        <a onclick="addRoleForm()" class="btn btn-primary pull-right" style="margin-top: -5px;color:#fff">Thêm mới</a>
                    </p>
                </div>
...
<script src="{{ asset('layout/backend/js/myscript/role.js') }}"></script>
@endpush
