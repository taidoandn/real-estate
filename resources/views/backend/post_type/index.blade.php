...
@include('backend.post_type._modal')
<!-- Main content -->
        ...
        <div class="col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <p class="panel-title">
                        DataTables Type
                        <a onclick="addTypeForm()" class="btn btn-primary pull-right" style="margin-top: -5px;color:#fff">Thêm mới</a>
                    </p>
                </div>
...
<script>
    var types_table = $('#types-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{!! route('admin.api.post-types') !!}",
        columns: [
            {data: 'id',name: 'id'},
            {data: 'name',name: 'name'},
...
<script src="{{ asset('layout/backend/js/myscript/post_type.js') }}"></script>
@endpush
