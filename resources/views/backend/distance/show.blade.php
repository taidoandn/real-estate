...
@include('backend.distance._modal')
<!-- Main content -->
        ...
        <div class="col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <p class="panel-title">
                        DataTables Distance
                        <a onclick="addDistanceForm()" class="btn btn-primary pull-right" style="margin-top: -5px;color:#fff">Thêm mới</a>
                    </p>
                </div>
                <div class="panel-body">
                    <table id="distances-table" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Name</th>
...
<script>
    var distances_table = $('#distances-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{!! route('admin.api.distances') !!}",
        columns: [
            {data: 'id',name: 'id'},
            {data: 'name',name: 'name'},
...
<script src="{{ asset('layout/backend/js/myscript/distance.js') }}"></script>
@endpush
