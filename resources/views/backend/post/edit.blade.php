...
<script src="{{ asset('layout/backend/js/myscript/load-district.js')}}"></script>
<script src="{{ asset('layout/backend/js/myscript/load-unit.js')}}"></script>
<script src="{{ asset('layout/backend/js/myscript/load-price.js')}}"></script>
@endpush
