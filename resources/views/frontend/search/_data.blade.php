            ...
            <ul class="listingViewIcon pull-right">
                <li class="dropdown shortByListingLi">
                    <a aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown" class="dropdown-toggle"
                        href="#">Short by <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="https://demo.themeqx.com/themeqxestate/listing?shortBy=price_high_to_low">Price
                                high to low</a></li>
                        <li><a href="https://demo.themeqx.com/themeqxestate/listing?shortBy=price_low_to_high">Price
                                low to high</a></li>
                        <li><a href="https://demo.themeqx.com/themeqxestate/listing?shortBy=latest">Latest</a></li>
                    </ul>
                </li>
                    ...
                    <div class="ads-item-thumbnail ad-box-regular">
                        ...
                        <div class="caption">
                            ...
                            <table class="table table-responsive property-box-info">
                                <tr>
                                    <td> <a class="location text-muted" href="#">
                                            <i class="fa fa-map-marker"></i> {{
                                            $post->district->city->name }}/{{ str_limit($post->district->name, 4) }}</a>
                                    </td>
                                    <td>
                ...
                <div class="col-md-12">
                    <table class="table table-bordered table-responsive">
                        ...
                        <tr class="ad-regular">
                            <td width="200px">
                                <a href="{{ route('detail', ['slug'=>$post->slug]) }}">
                                    <img src="{{ asset('uploads/images/'.$post->image) }}" class="img-responsive" alt="{{ $post->title }}">
                                    <span class="modern-sale-rent-indicator">
                                        {{ ucfirst($post->purpose) }}
                                    </span>
                                </a>
